  ...
  */
  buildTableBody(){
    ...
    for(let i = 0; i < this.tasks.length; i++){
      ...
      html += '<td class="event-cell" colspan="'+days+'" style="background-color: '+task[3]+';"><span style="font-size: 18px;">'+task[4]+'</span><span style="font-size: 18px;">'+(days-1)+' dias</span><p style="font-size: 18px; display:inline-block;">'+task[0]+'&nbsp;</p><form style="display: inline-block;" action="../class/Gantt.php/" method="post"><input type="hidden" name="idtask" value="'+task[5]+'"><input type="hidden" name="val" value="Eliminar"><input style="width:47px; height: 35px; background-color: red; border-width: 1px; border-radius: 15px;" type="submit" value="Eliminar"></form></td>';
