<<<<<<<< HEAD:Herramientas/Login/assets/user.php
<?php
  class user{
    public $name;
    public $surname;
...
<?php
  class user{
    ...
    public function SignUp($name_p, $surname_p, $nameuser_p, $telephono_p, $email_p, $password_p, $fileName, $filePath){
    ...
    public function InsertFormulaCalculator(){

    }
  };
?>
>>>>>>>> 92fad7a9998368220492c22770b5e391a372a910:Herramientas/Login/Clases/user.php
